...
const callGeminiAPI = async (systemPrompt, userMessage) => {
    ...
    try {
        ...
        // 5. Extração da Resposta do Modelo
        ...
        // showNotification(`Falha da IA: ${error.message}`, 'error'); // Removido para evitar dependência de showNotification aqui
